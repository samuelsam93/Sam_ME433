    ...
    switch(appData.state)
    {
        ...
        case APP_STATE_CHECK_CDC_READ:
            ...
            if(appData.isReadComplete == true)
            {
                ...
                scanf("%d", appData.readBuffer);
                int readval = appData.readBuffer[0];

                if(readval > 50 && readval < 75)
                {
                    OC1RS = 600;
                    OC2RS = 600;
                }
...
//            }
            ...
            //PIC SENDING DATA CODE

//            startcount = _CP0_GET_COUNT();
//            sent = 0;
//            while (!sent)
//            {
//                nowcount = _CP0_GET_COUNT() - startcount;
//                if (nowcount >= 20000000)
//                {
//
//                    sprintf(message, "%d", i);
//                    writeRequestResult = USB_DEVICE_CDC_Write(0, &appData.writeTransferHandle, message, 256, USB_DEVICE_CDC_TRANSFER_FLAGS_DATA_COMPLETE);
//                    i++;
//                    sent = 1;
//
